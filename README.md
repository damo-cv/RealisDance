...
## Gallery
Here are several **finger dances** genereated by RealisDance.
...
**Smoothness Comparison** between our method and Moore-Animate Anyone.

[![Smoothness Comparison](https://res.cloudinary.com/marcomontalbano/image/upload/v1725008644/video_to_markdown/images/youtube--YRldLz1AG3I-c05b58ac6eb4c4700831b2b3070cd403.jpg)](https://www.youtube.com/watch?v=YRldLz1AG3I "Smoothness Comparison")
...
{
    "data_key": id_of_data,
    "image": target_image_or_video,  # video should in shape (B, C, F, H, W)
    "pose": target_dwpose_image_or_video,  # video should in shape (B, C, F, H, W)
    "hamer": target_hamer_image_or_video,  # video should in shape (B, C, F, H, W)
    "smpl": target_smpl_image_or_video,  # video should in shape (B, C, F, H, W)
